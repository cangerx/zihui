...
class UpdateController extends Controller
{
    ...
    public function current()
    {
        return response()->json([
            ...
            'name' => config('version.name', 'Agent Admin'),
    ...
    /**
     * 查询升级进度
     * GET /api/admin/updates/progress?log_id=xxx
     */
    ...
    /**
     * 升级历史
     * GET /api/admin/updates/history?per_page=20
     */
    ...
    /**
     * 数据表完整性检查
     * GET /api/admin/updates/db-check
     */
     ...
     * POST /api/admin/updates/db-repair
     */
    ...
    /**
     * 历代版本更新记录
     * GET /api/admin/updates/releases
     */
