...
/**
 * 与 agent-admin CloudBuildLedgerCanonical 保持同算法；契约见
 * agent-admin/docs/contracts/cloud-build-migration/verify-fixture.cjs。
 */
class BuildLedgerCanonical
{
