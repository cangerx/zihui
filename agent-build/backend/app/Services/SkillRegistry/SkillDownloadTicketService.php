...
class SkillDownloadTicketService
{
    public function __construct(
        ...
        if ($this->secret === '') {
            $this->secret = (string) (getenv('SKILL_REGISTRY_TICKET_SECRET') ?: '');
        }
        if ($this->baseUrl === '') {
            $this->baseUrl = rtrim((string) (getenv('SKILL_REGISTRY_DOWNLOAD_BASE') ?: '/api/skills/v1/download'), '/');
        }
    }
